        ...
        <div class="flex flex-col w-full p-8 h-screen">
            <section id="properties" class="mb-12 w-9/10">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-cognac-800 ml-6">My Properties</h2>
                </div>
                        ...
                        <div class="bg-white rounded-xl p-4 hover:shadow-md transition-shadow mb-3">
                            ...
                            <div class="flex flex-row items-center justify-between">
                                <div class="flex flex-col">
                                    ...
                                    <h3 class="font-semibold text-cognac-800">{{ $booking->apartment->country }}, {{ $booking->apartment->city }}, {{ $booking->apartment->street }}</h3>
                                </div>
                                <div class="flex flex-col">
                                    <h3 class="font-semibold text-cognac-800">Reserved at: {{ date('Y-m-d', strtotime($booking->reserved_at)) }}</h3>
                                    <h3 class="font-semibold text-cognac-800">Expired at: &nbsp;&nbsp;&nbsp;{{ date('Y-m-d', strtotime($booking->expired_at))}}</h3>
                                </div>
                            </div>
                        </a>
                        </div>
        ...
        <div class="w-66 bg-cognac-800 text-white p-6 space-y-8 fixed right-0 h-screen">
            <div class="flex flex-col items-center space-y-4">
                ...
                <div class="text-center">
                    <h2 class="font-bold text-4xl">{{ $user->name }}</h2>
                    <p class="text-xl opacity-75">{{ $user->email }}</p>
                </div>
            </div>
